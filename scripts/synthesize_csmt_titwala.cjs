...
const backup = path.join(__dirname, '../src/data/mumbai_local_train_tracking.json.bak3');
...
const trainNumber = 'SIM_CS_TIT_1';
const synthesized = pathStations.map((stationName, i) => {
